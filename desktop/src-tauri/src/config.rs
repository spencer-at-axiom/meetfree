...
/// Default summary provider for fresh installs and legacy provider migration.
pub const DEFAULT_SUMMARY_PROVIDER: &str = "ollama";

/// Default summary model for the local-first path.
pub const DEFAULT_SUMMARY_MODEL: &str = "gemma3:1b";
