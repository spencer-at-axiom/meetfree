@echo off
REM Build script for Windows with CUDA GPU acceleration
...
echo.
echo ========================================
echo   MeetFree - CUDA GPU Build
echo ========================================
echo.
echo Building Tauri with CUDA GPU acceleration...
echo.
...
REM Build Tauri with CUDA feature
pnpm run tauri build -- --features cuda
