...
- The frontend keeps analytics call sites in place, but the current `desktop/src/lib/analytics.ts` shim is a no-op and does not send analytics events to a remote service.
